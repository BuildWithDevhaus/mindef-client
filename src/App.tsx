  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/admin/delete-inventory/edit/:rfidNo"
          element={<PrivateRoute isAuthenticated={isAuthenticated} element={<AdminEditDeleteInventory />} />}
        />
        <Route
        ...
        />
        <Route
          path="/admin/delete-reasons/edit/:deleteReasonId"
          element={<PrivateRoute isAuthenticated={isAuthenticated} element={<AdminEditDeleteReason />} />}
        />
        <Route
          path="/admin/reports"
        ...
        />
        <Route
          path="/admin/unit-wing/edit/:unitWingId"
