  ...
  return (
    <>
      <div className="flex items-center h-full justify-between px-[10%]">
        ...
        <img src={shirtMaleNo1} alt="Shirt Image" className="w-[45%]" />
        <ContainerLayout className="w-[45%]">
          <InputContainerLayout variant="small" title="1. Shoulder Length" label="Width">
            <SelectOptionPrimary
              placeholder="Select your Shoulder Length"
              name="shoulderLen"
              value={inputValue.shoulderLen}
              onChange={(e) => handleChange("shoulderLen", e.target.value)}
              className="text-sm bg-white bg-[length:32px]"
            >
              {
                shirtDimensions
          ...
          <InputContainerLayout variant="small" title="2. Sleeve" label="Length">
            <SelectOptionPrimary
          ...
          <InputContainerLayout variant="small" title="3. Collar Length" label="Width">
            <SelectOptionPrimary
          ...
          <ButtonPrimary variant="default" onClick={handleConfirm}>Submit</ButtonPrimary>
        </ContainerLayout>
      </div>
