...
const StepPants: React.FC<ManualMeasurementFormStepSubmitProps> = ({
  ...
  return (
    <>
      <div className="flex items-center h-full justify-between px-[15%]">
        {/* TODO: Change Image based on option */}
        <img src={pantsMaleNo1} alt="Pants Image" className="w-[40%]" />
        <ContainerLayout className="w-[50%]">
          <InputContainerLayout variant='small' title="1. Waist" label="Width">
            <SelectOptionPrimary
          ...
          <InputContainerLayout variant='small' title="2. Pants Length" label="Length">
            <SelectOptionPrimary
