        ...
        <ContainerLayout>
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-2">
              ...
              <p>{ shirtData ? `Description: No. 1, Male Shirt, Infantry` : `Description: No. 1, Male Pants, Infantry` }</p>
            </div>
            <div>
              <img className="h-[100px]" src={shirtData ? shirtMaleNo1 : pantsMaleNo1} alt="Uniform Image"/>
            </div>
          </div>
          ...
          <ButtonPrimary className="text-xl font-medium" onClick={() => handleSubmit}>Confirm</ButtonPrimary>
        </ContainerLayout>
      </form>
    </div>
  );
